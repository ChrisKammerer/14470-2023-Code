...
public class GigaRigged3Cone extends LinearOpMode {
    ...
    enum State{
        ...
        TRAJECTORY_9, // move to short pole
        TURN_4, // turn to face short pole
        WAIT_5, // drop cone
        TRAJECTORY_10, // move away from short pole
        TURN_5, //turn back to original position
    ...
    public void runOpMode() {
        ...
        Trajectory trajectory8 = drive.trajectoryBuilder(trajectory7_5.end().plus(new Pose2d(0,0,Math.toRadians(45))))
                .lineTo(new Vector2d(48,26))
                .build();
        //Trajectory 9: move to pole position
        Trajectory trajectory9 = drive.trajectoryBuilder(trajectory8.end().plus(new Pose2d(0,0,Math.toRadians(180))))
                .lineTo(new Vector2d(48, 20))
                .build();
        //Trajectory 10: move back from pole
        ...
        Trajectory trajectoryPark = drive.trajectoryBuilder(trajectory10.end().plus(new Pose2d(0,0,180)))
